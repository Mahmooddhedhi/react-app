            ...
            {inddata && Object.keys(inddata).length &&
                <div className='cart_container'>
                    ...
                    <div className='right_cart'>
                        ...
                        <Divider />
                        <p className='rs'>R.S :{inddata.price.mrp}</p>
                        <p>Deal Of The Day : <span style={{ color: "#B12704" }}> Rs : {inddata.price.cost}.00</span></p>
                        <p>You Save : <span style={{ color: "#B12704" }}> Rs {inddata.price.mrp - inddata.price.cost}  .00 ({inddata.price.discount})</span></p>
                        <div className='discount_box'>
                            <h5>Discount : <span style={{ color: "#111" }}>{inddata.discount}</span></h5>
                            <h4>Free Delivery : <span style={{ color: "#111", fontWeight: 600 }}> Aug 18 - 21</span> Details</h4>
